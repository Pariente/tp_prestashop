<?php /* Smarty version Smarty-3.1.19, created on 2016-06-03 14:37:14
         compiled from "/Applications/MAMP/htdocs/prestashop/admin720zdrbg5/themes/default/template/controllers/themes/helpers/options/options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1100383065575179faea6a97-53841546%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7e83029d85b245f85f0fd241bc326d298ad0531' => 
    array (
      0 => '/Applications/MAMP/htdocs/prestashop/admin720zdrbg5/themes/default/template/controllers/themes/helpers/options/options.tpl',
      1 => 1452091828,
      2 => 'file',
    ),
    '2537b8fec3a2e7a8206eced075ed11689738d477' => 
    array (
      0 => '/Applications/MAMP/htdocs/prestashop/admin720zdrbg5/themes/default/template/helpers/options/options.tpl',
      1 => 1452091828,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1100383065575179faea6a97-53841546',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_575179fb2c3e61_56681752',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_575179fb2c3e61_56681752')) {function content_575179fb2c3e61_56681752($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/Applications/MAMP/htdocs/prestashop/tools/smarty/plugins/function.counter.php';
...
if (!is_callable('smarty_modifier_replace')) include '/Applications/MAMP/htdocs/prestashop/tools/smarty/plugins/modifier.replace.php';
?>
...
" class="btn btn-default">
												...
												<?php if ($_smarty_tpl->tpl_vars['theme']->value->name!='default-bootstrap'||($_smarty_tpl->tpl_vars['theme']->value->name=='default-bootstrap'&&$_smarty_tpl->tpl_vars['host_mode']->value==0)) {?>
...
" />
					...
					<?php } ?>
					<?php  $_smarty_tpl->tpl_vars['theme'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['theme']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['field']->value['not_installed']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['theme']->key => $_smarty_tpl->tpl_vars['theme']->value) {
$_smarty_tpl->tpl_vars['theme']->_loop = true;
?>
						<div class="col-sm-4 col-lg-3">
...
<?php }?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['categoryData']->value['after_tabs'])) {?>
		<?php $_smarty_tpl->tpl_vars['cur_theme'] = new Smarty_variable($_smarty_tpl->tpl_vars['categoryData']->value['after_tabs']['cur_theme'], null, 0);?>
...
',
			...
			success: function(htmlData) {
				$("#prestastore-content").html("<h3><i class='icon-picture-o'></i> <?php echo smartyTranslate(array('s'=>'Live from PrestaShop Addons!'),$_smarty_tpl);?>
</h3>"+htmlData);
			}
		});
